    ...
    <div className="container mx-auto flex flex-col gap-y-6">
          ...
          <nav className="mt-1">
            <div className="flex items-center">
              <ul className="flex gap-x-3">
                ...
                <li>
                  <Link to="/plants" onClick={closeSidebar}>
                    Augalai
                  </Link>
                </li>
                {isAdmin() && (
                  <>
                    ...
                    <li>
                      <Link to="/soils" onClick={closeSidebar}>
                        Dirvožemiai
                      </Link>
                    </li>
                  </>
      ...
      <div>
        {navigation.state !== "idle" && (
          <div className="m-1">Navigaion in progress...</div>
        )}
        {fetcherInProgress && (
          <div className="m-1"> Fetcher in progress...</div>
        )}
      </div>
